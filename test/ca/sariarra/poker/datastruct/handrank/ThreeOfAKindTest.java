...
public class ThreeOfAKindTest {
	...
	@Test
	public void testHighThreeOfAKindCheckingPositiveCases() {
		boolean wantHighRank = true;
		HandRank res = ThreeOfAKind.doTheseCardsMakeThisHandRank(new Card[] {
		...
		assertIsThreeOfAKind(res, false, new Card[] {
				new Card(Rank.TWO, Suit.CLUBS),
				new Card(Rank.TWO, Suit.HEARTS),
				new Card(Rank.TWO, Suit.DIAMONDS),
				new Card(Rank.SIX, Suit.DIAMONDS),
		...
		res = ThreeOfAKind.doTheseCardsMakeThisHandRank(new Card[] {
				new Card(Rank.THREE, Suit.CLUBS),
	...
	private void assertIsThreeOfAKind(HandRank r, boolean expectToFail, Card[] expCards) {
		if (expectToFail) {
